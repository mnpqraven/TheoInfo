...
- $\Sigma^* - L_2$ mit $\Sigma = \{a,b\} = \{bx, a^n b^m, xbay$ $|$ $x,y \in \Sigma^* \land n,m \in \mathbb{N} \land m > n\}$, also diese Äquivalenzklasse enthält alle Wörte, die nicht in $L_2$ sind.
